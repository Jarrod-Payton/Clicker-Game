...
import { defaultPurchasingService } from "../services/DefaultPurchasingService";
...
export default {
  ...
  setup() {
    ...
    return {
      ...
      cost50,
      cost100,
      increaseAmplifier(amount, cost) {},
      tap() {
        defaultPurchasingService.click();
      },
      points: computed(() => AppState.defaultGame.points),
      amplifier: computed(() => AppState.defaultGame.amplifier),
    };
  },
};
</script>
